...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col px-6 pt-16 lg:px-28">
      <Header />

      <div className="w-full overflow-hidden py-20 md:py-44 2xl:w-1/2">
        <svg
        ...
        <div className="text-balance text-primary">
